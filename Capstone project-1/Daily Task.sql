TPCDS.INTERMEDIATE.CREATING_DAILY_AGGREGATED_SALES_INCREMENTALLYTPCDS.ANALYTICS.CUSTOMER_DIMCREATE OR REPLACE PROCEDURE tpcds.INTERMEDIATE.populating_daily_aggregated_sales_incrementally()
  RETURNS VARCHAR
  LANGUAGE SQL
  AS
  $$
